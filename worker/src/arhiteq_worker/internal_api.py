...
Every request carries ``X-Internal-Token: <ARHITEQ_INTERNAL_TOKEN>``.
"""
...
logger = logging.getLogger("arhiteq-worker.internal-api")
...
class InternalAPI:
    def __init__(
        ...
        self._base_url = (base_url or os.environ["ARHITEQ_API_URL"]).rstrip("/")
        self._token = token or os.environ["ARHITEQ_INTERNAL_TOKEN"]
